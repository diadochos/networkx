...
Generates a networkx_v1.DiGraph from point and line shapefiles.
...
def read_shp(path, simplify=True):
    """Generates a networkx_v1.DiGraph from shapefiles. Point geometries are
...
def write_shp(G, outdir):
    """Writes a networkx_v1.DiGraph to two shapefiles, edges and nodes.
