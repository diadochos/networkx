...
from networkx_v1.classes.graph import Graph  # for doctests
from networkx_v1.classes.digraph import DiGraph
from networkx_v1.classes.multigraph import MultiGraph
