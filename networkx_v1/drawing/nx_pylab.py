...
from networkx_v1.drawing.layout import shell_layout,\
...
def draw(G, pos=None, ax=None, hold=None, **kwds):
    ...
    pos : dictionary, optional
       ...
       See networkx_v1.layout for functions that compute node positions.
    ...
    kwds : optional keywords
       See networkx_v1.draw_networkx() for a description of optional keywords.
...
def draw_shell(G, **kwargs):
    """Draw networkx_v1 graph with shell layout.
...
def draw_graphviz(G, prog="neato", **kwargs):
    """Draw networkx_v1 graph with graphviz layout.
