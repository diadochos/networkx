...
def _prep_create_using(create_using):
    ...
    If create_using is None return the default (just networkx_v1.Graph())
    If create_using.clear() works, assume it returns a graph object.
    Otherwise raise an exception because create_using is not a networkx_v1 graph.
    ...
    try:
        ...
        raise TypeError("Input graph is not a networkx_v1 graph type")
    return create_using
