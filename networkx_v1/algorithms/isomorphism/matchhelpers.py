...
Examples
--------
>>> import networkx_v1.algorithms.isomorphism as iso
...
>>> from networkx_v1.algorithms.isomorphism.matchhelpers import close
>>> from networkx_v1.algorithms.isomorphism import generic_node_match
