...
The bipartite algorithms are not imported into the networkx_v1 namespace
at the top level so the easiest way to use them is with:

>>> import networkx_v1 as nx
>>> from networkx_v1.algorithms import bipartite
...
from networkx_v1.algorithms.bipartite.basic import *
from networkx_v1.algorithms.bipartite.centrality import *
from networkx_v1.algorithms.bipartite.cluster import *
from networkx_v1.algorithms.bipartite.edgelist import *
from networkx_v1.algorithms.bipartite.matching import *
from networkx_v1.algorithms.bipartite.matrix import *
from networkx_v1.algorithms.bipartite.projection import *
from networkx_v1.algorithms.bipartite.redundancy import *
from networkx_v1.algorithms.bipartite.spectral import *
from networkx_v1.algorithms.bipartite.generators import *
