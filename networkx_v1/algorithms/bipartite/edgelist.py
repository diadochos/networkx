...
from networkx_v1.utils import open_file, make_str, not_implemented_for
from networkx_v1.convert import _prep_create_using
...
def read_edgelist(path, comments="#",
    ...
    create_using : Graph container, optional,
       Use specified container to build graph.  The default is networkx_v1.Graph,
       an undirected graph.
    ...
    -------
    G : graph
       A networkx_v1 Graph or other type specified with create_using
