...
class TestHITS:
    ...
    def test_hits_nstart(self):
        ...
        h, a = networkx_v1.hits(G, nstart = nstart)
    ...
    def test_empty(self):
        try:
            ...
            raise SkipTest('numpy not available.')
        G=networkx.Graph()
        assert_equal(networkx_v1.hits(G),({},{}))
        assert_equal(networkx_v1.hits_numpy(G),({},{}))
        assert_equal(networkx_v1.authority_matrix(G).shape,(0,0))
        assert_equal(networkx_v1.hub_matrix(G).shape,(0,0))
    ...
    def test_empty_scipy(self):
        try:
            ...
            raise SkipTest('scipy not available.')
        G=networkx.Graph()
        assert_equal(networkx_v1.hits_scipy(G),({},{}))
