...
class TestEigenvectorCentralityExceptions(object):
    ...
    def test_multigraph(self):
        e = networkx_v1.eigenvector_centrality(networkx_v1.MultiGraph())

    @raises(networkx_v1.NetworkXException)
    def test_multigraph_numpy(self):
        e = networkx_v1.eigenvector_centrality_numpy(networkx_v1.MultiGraph())


    @raises(networkx_v1.NetworkXException)
    def test_empty(self):
        e = networkx_v1.eigenvector_centrality(networkx_v1.Graph())

    @raises(networkx_v1.NetworkXException)
    def test_empty_numpy(self):
        e = networkx_v1.eigenvector_centrality_numpy(networkx_v1.Graph())
