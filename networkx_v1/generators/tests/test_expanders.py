...
"""Unit tests for the :mod:`networkx_v1.generators.expanders` module.
...
from networkx_v1 import adjacency_matrix
from networkx_v1 import number_of_nodes
from networkx_v1.generators.expanders import chordal_cycle_graph
from networkx_v1.generators.expanders import margulis_gabber_galil_graph
...
def test_chordal_cycle_graph():
    """Test for the :func:`networkx_v1.chordal_cycle_graph` function."""
